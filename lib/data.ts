...
export const campaigns: Campaign[] = [
  // CLIPPING CAMPAIGNS (Short-Form Video)
  {
    id: 1,
    brand: "NordVPN",
    brandInitial: "N",
    ...
    rate: "CPM $8",
    rateType: "cpm",
    title: "Short-Form Clipping Campaign",
    description: "Create TikTok/Reels/Shorts content with our brand overlay. Simply upload your video, apply our branded asset, and earn based on views. Gaming, tech, and lifestyle creators welcome.",
    channels: ["TikTok", "Reels", "Shorts"],
    budget: "$25,000",
    spots: 200,
    accentColor: "#4A7CFF",
    isClipping: true,
    brandAssetUrl: "/brands/nordvpn.png",
    cpm: 8,
    minFollowers: 5000,
    minViews: 1000,
    totalBudget: 25000,
  },
  {
    ...
    rate: "CPM $12",
    rateType: "cpm",
    title: "Gaming Clips Campaign",
    description: "Overlay our Stake branding on your gaming clips for TikTok, Reels, and Shorts. Perfect for casino, slots, and gaming content creators. Higher CPM for quality content.",
    channels: ["TikTok", "Reels", "Shorts"],
    budget: "$50,000",
    spots: 500,
    accentColor: "#00D632",
    isClipping: true,
    brandAssetUrl: "/brands/stake.png",
    cpm: 12,
    minFollowers: 10000,
    minViews: 5000,
    totalBudget: 50000,
  },
  // NON-CLIPPING CAMPAIGNS (Templates/Placeholders)
  {
    id: 3,
